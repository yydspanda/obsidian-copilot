...
- 在 ready delegate 前修复 `ProjectFileManager`/`ProjectManager` singleton 的跨插件实例/跨 Vault ownership，并让 in-flight Project scan 的最终 cache commit 受当前 lifecycle token 约束。
