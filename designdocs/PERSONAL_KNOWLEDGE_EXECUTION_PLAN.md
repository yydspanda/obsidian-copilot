...
- [ ] 将 bounded worker session 接到 production Queue，并执行完整 artifact/projection validator、exact-byte executor/Compiler/Review hand-off；fresh adapter 必须在外泄前直接交给预期 Compiler。
