...
- [ ] 在已完成 fresh Gate/conditional release 的 plugin-owned observation session 上执行完整 artifact/projection validator、exact-byte executor/Compiler/Review hand-off 与 worker；fresh adapter 必须在外泄前直接交给预期 Compiler。
