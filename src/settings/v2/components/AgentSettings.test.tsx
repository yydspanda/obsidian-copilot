...
describe("AgentSettings", () => {
  ...
  it("places the MCP panel after the backend tab strip, at the end of the section", () => {
    render(<AgentSettings />);
    const tablist = screen.getByRole("tablist");
    const mcp = screen.getByTestId("mcp-panel");
    // DOCUMENT_POSITION_FOLLOWING means `mcp` comes after the strip in the DOM.
    expect(tablist.compareDocumentPosition(mcp) & Node.DOCUMENT_POSITION_FOLLOWING).toBeTruthy();
  });
