 ...
 * default-backend picker, a sub-tab strip with one panel per backend plus a
 * Quick Chat panel, and the MCP server panel at the end. Each backend panel
 * curates that backend's default model, enabled models, and binary/auth config.
 *
            ...
            <div className="tw-flex tw-min-w-0 tw-items-center tw-gap-2">
              ...
              <div className="tw-flex tw-min-w-0 tw-flex-col">
                <div className="tw-flex tw-items-center tw-gap-2">
                  ...
                  {InlineInstall && (
                    <Badge variant="outline" className="tw-font-normal">
                      Recommended
                    </Badge>
                  )}
                </div>
